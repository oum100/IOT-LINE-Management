...
const rangeOrderTotal = computed(() => totals.value.orders)
const rangePaymentTotal = computed(() => totals.value.payments)
        ...
        <div class="grid gap-3 sm:grid-cols-[1.15fr_1fr] sm:items-stretch">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="rounded-lg border border-blue-300/70 bg-blue-100/80 px-3 py-2 dark:border-blue-900/60 dark:bg-blue-950/35">
              ...
              <p class="text-xl font-extrabold text-blue-700 dark:text-blue-300">{{ fmtNumber(rangeOrderTotal) }}</p>
            </div>
            <div class="rounded-lg border border-violet-300/70 bg-violet-100/80 px-3 py-2 dark:border-violet-900/60 dark:bg-violet-950/35">
              ...
              <p class="text-xl font-extrabold text-violet-700 dark:text-violet-300">{{ fmtNumber(rangePaymentTotal) }}</p>
            </div>
      ...
      <UCard :ui="{ root: 'ring-1 ring-slate-200/70 bg-white dark:ring-slate-700 dark:bg-slate-900', body: 'p-3' }">
        <div class="grid grid-cols-[1fr_auto] items-start gap-3">
          ...
          <div class="grid grid-cols-3 gap-1 text-[11px]">
            ...
            <span class="rounded-md border border-blue-200 bg-blue-50 px-2 py-0.5 text-center font-medium text-blue-700 dark:border-blue-900/60 dark:bg-blue-950/30 dark:text-blue-300">BOUND {{ fmtNumber(device.inUse) }}</span>
      ...
      <UCard :ui="{ root: 'ring-1 ring-slate-200/70 bg-white dark:ring-slate-700 dark:bg-slate-900', body: 'p-3' }">
        <div class="grid grid-cols-[1fr_auto] items-start gap-3">
          ...
          <div class="grid grid-cols-3 gap-1 text-[11px]">
            ...
            <span class="rounded-md border border-blue-200 bg-blue-50 px-2 py-0.5 text-center font-medium text-blue-700 dark:border-blue-900/60 dark:bg-blue-950/30 dark:text-blue-300">BOUND {{ fmtNumber(machine.inUse) }}</span>
